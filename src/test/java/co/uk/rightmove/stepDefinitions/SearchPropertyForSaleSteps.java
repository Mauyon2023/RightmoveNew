...
public class SearchPropertyForSaleSteps {
    ...
    @When("I select minimun price of {string}")
    public void i_select_minimun_price_of(String string) {
    ...
    @When("I click on find property")
    public void i_click_on_find_property() {
    ...
    @When("I click on second result")
    public void i_click_on_second_result() {
